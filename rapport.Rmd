...
Cette granularité permet d’éviter qu’un sport regroupant des épreuves très différentes (par exemple la natation ou la gymnastique) masque des relations importantes entre morphologie et performance.
...
Contrairement à l’analyse réalisée au niveau des sports globaux, l’analyse par épreuve révèle des corrélations nettement plus fortes, atteignant **|r| $\approx$ 0.57**.
...
Les sports techniques ou soumis à des contraintes physiques fortes (équilibre, explosivité, rapport poids/puissance) semblent particulièrement sensibles aux variations de morphologie.

Cette analyse suggère également que **l’échelle d’analyse est cruciale** : observer un sport dans son ensemble peut masquer des tendances importantes visibles uniquement au niveau des épreuves individuelles.
...
Cela peut s’expliquer par l’importance d’un **rapport force/poids optimal**, essentiel pour exécuter des figures complexes tout en conservant stabilité et contrôle.
...
La pente descendante de la droite de régression indique qu’un **IMC plus élevé est associé à un temps plus faible**, donc à une meilleure performance.
